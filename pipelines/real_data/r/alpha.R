...
# New paths
#path <- paste0("~/repos/ancient_migration/analyses/general/output/sgpd_replication/segments/1791095846/S_Sardinian-1.", pop, ".bed")
#path <- paste0("~/repos/ancient_migration/analyses/general/", input)
modif_snps %>% filter_bed(input) -> modif_segs
...
#path_all <- paste0(output, "/alpha_all.txt")
#path_segs <- paste0(output, "/alpha_segs.txt")
path_all <- paste0(output, "/d_all.txt")
path_segs <- paste0(output, "/d_segs.txt")
